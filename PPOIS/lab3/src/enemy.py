...
from src.manager import ScoreManager, Background
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, screen, x, y, target):
        ...
        self.normalImage = pygame.image.load(utilities.get_image("Walker.png")).convert_alpha()
        self.hurtImage = pygame.image.load(utilities.get_image("Walker_hurt.png")).convert_alpha()
    ...
    def update(self, projectiles, powers):
        ...
        if self.alive:
            self.angle = utilities.angle_between_points(self.x, self.y, self.target.x, self.target.y)
            ...
            image_to_draw, image_rect = utilities.get_rotated_image(imageToRotate, self.rect, -self.angle)
...
class Brute(Enemy):
    def __init__(self, screen, x, y, target):
        ...
        self.normalImage = pygame.image.load(utilities.get_image("Brute.png")).convert_alpha()
        self.hurtImage = pygame.image.load(utilities.get_image("Brute_hurt.png")).convert_alpha()
        self.image = self.normalImage
        self.speed = 2
        self.max_health = 100
        self.health = self.max_health
...
class Crawler(Enemy):
    def __init__(self, screen, x, y, target):
        super().__init__(screen, x, y, target)
        self.hurtImage = pygame.image.load(utilities.get_image("Crawler_hurt.png")).convert_alpha()
        self.normalImage = self.normalImage
        self.normalImage = pygame.image.load(utilities.get_image("Crawler.png")).convert_alpha()
        self.speed = 1.5
        self.max_health = 75
        self.health = self.max_health
        self.angle = 90
...
class Helicopter(Enemy):
    def __init__(self, screen, x, y, target):
        super().__init__(screen, x, y, target)
        self.hurtImage = pygame.image.load(utilities.get_image("helicopter_hurt.png")).convert_alpha()
        self.normalImage = pygame.image.load(utilities.get_image("helicopter.png")).convert_alpha()
...
class Spider(Enemy):
    def __init__(self, screen, x, y, target):
        super().__init__(screen, x, y, target)
        self.hurtImage = pygame.image.load(utilities.get_image("Spider_hurt.png")).convert_alpha()
        self.image = pygame.image.load(utilities.get_image("Spider.png")).convert_alpha()
        self.speed = 10
        self.max_health = 45
        self.health = self.max_health
        self.damage = 20
...
class Runner(Enemy):
    def __init__(self, screen, x, y, target):
        super().__init__(screen, x, y, target)
        self.hurtImage = pygame.image.load(utilities.get_image("Runner_hurt.png"))
        self.image = pygame.image.load(utilities.get_image("Runner.png"))
        self.speed = 100
        self.max_health = 15
        self.health = self.max_health
        self.damage = 50
...
class Motorcycle(Enemy):
    def __init__(self, screen, x, y, target):
        super().__init__(screen, x, y, target)
        self.hurtImage = pygame.image.load(utilities.get_image("Motorcycle_hurt.png"))
        self.image = pygame.image.load(utilities.get_image("Motorcycle.png"))
        self.speed = 5
        self.max_health = 30
        self.health = self.max_health
        self.damage = 20
